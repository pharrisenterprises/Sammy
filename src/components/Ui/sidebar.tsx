  ...
  return (
    <div
      ...
      <div
        ...
        <div
          data-sidebar="sidebar"
          className="flex h-full w-full flex-col bg-[#0d1425] group-data-[variant=floating]:rounded-lg group-data-[variant=floating]:border group-data-[variant=floating]:border-sidebar-border group-data-[variant=floating]:shadow">
          {children}
        </div>
      </div>
    </div>
...
const SidebarTrigger = React.forwardRef<HTMLButtonElement, React.ButtonHTMLAttributes<HTMLButtonElement>>(({ className, onClick, ...props }, ref) => {
...
const SidebarGroupLabel = React.forwardRef<any, SidebarGroupLabelProps>(({ className, asChild = false, ...props }, ref) => {
...
interface SidebarMenuButtonProps extends React.ButtonHTMLAttributes<HTMLButtonElement> {
  ...
  size?: "default" | "sm" | "lg";
  tooltip?: string | React.ComponentPropsWithoutRef<typeof TooltipContent> & { children?: React.ReactNode };
}
  ...
  return (
    <Comp
      ...
      className={cn(
        ...
        "group-data-[collapsible=icon]:hidden",
        showOnHover ?
          "group-focus-within/menu-item:opacity-100 group-hover/menu-item:opacity-100 data-[state=open]:opacity-100 peer-data-[active=true]/menu-button:text-sidebar-accent-foreground md:opacity-0" : undefined,
        className
      )}
      {...props} />
  );
